 ...
 * Handles repeated references to the same $N by expanding the params array.
 * Example: ("WHERE x = $1 OR y = $1", [val]) → ("WHERE x = ? OR y = ?", [val, val])
 */
...
const initializeDatabase = (async () => {
  ...
  console.log("[Database] SQLite schema ensured");
})();
