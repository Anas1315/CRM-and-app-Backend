...
void applyRelayControls() {
  ...
  Serial.printf("[Scheduler] RTC Time: %02d:%02d | Range: %s to %s | Parsed: %02d:%02d - %02d:%02d | Day=%d\n",
                now.hour(), now.minute(), serverDayStart.c_str(), serverDayEnd.c_str(), sH, sM, eH, eM, isDay);
